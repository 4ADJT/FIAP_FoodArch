...
public class UpdateRestaurantTableController {
    ...
    public ResponseEntity<RestaurantTablesOutput> updateRestaurantTable(@PathVariable UUID restaurantTableId, @RequestParam("ownerId") UUID ownerId, @RequestBody RestaurantTablesInput restaurantTablesInput) {
        RestaurantTables restaurantTables = updateRestaurantTable.execute(restaurantTableId, ownerId, restaurantTablesInput);
