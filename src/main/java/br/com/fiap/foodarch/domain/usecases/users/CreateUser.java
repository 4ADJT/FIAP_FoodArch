...
public class CreateUser {
    ...
    public CreateUser(UserRepository repository, CreateUserFactory factory) {
        this.repository = repository;
        this.factory = factory;
    }

    public User execute(UserInput userInput) {
        User user = factory.createUser(userInput.name(), userInput.email(), userInput.birthdate(), userInput.cpf());
